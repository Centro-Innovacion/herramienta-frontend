<template>
  <div id="Menu">
    ...
    <div class="Encabezado">
      ...
      <h1> | </h1>
      <span class="QUIERO-SABER">SECCIÓN 1. QUIERO SABER</span>
    </div>
    ...
    <div class="Encabezado">
      ...
      <h1> | </h1>
      <span class="QUIERO-SABER">SECCIÓN 2. QUIERO ACOMPAÑAMIENTO</span>
    </div>
    <div class="descripcion">
...
#Menu .Socializacion img {
  width: 92px;
  height:90px;
  margin: 20px 15px 10px 25px;/*top-right-bottom-left*/
}
#Menu .Socializacion .Lnea-5 {
  width: 0;
  height: 159px;
  margin: 0px 0 43.5px;/*top-right-bottom-left*/
  border: solid 1px #e6effd;
}
#Menu.Socializacion p {
  width: 161px;
  height: 24px;
  margin: 14px 20px 0 0;/*top-right-bottom-left*/
  font-family: Montserrat;
...
#Menu .Fortalecimiento {
  width: 509px;
  height: 160px;
  margin: 10px 10px 10px 100px;
  padding: 0px 30px 42px 0px;/*top-right-bottom-left*/
  border-radius: 20px;
  background-color: #ffffff;
  display: flex;
  justify-content: space-around;
}
#Menu .Fortalecimiento img {
  width: 92px;
  height:90px;
  margin: 20px 15px 10px 45px;/*top-right-bottom-left*/
}
#Menu .Fortalecimiento .Lnea-6 {
  width: 0;
  height: 159px;
  margin: 0px 0 43.5px;/*top-right-bottom-left*/
  border: solid 1px #e6effd;
}
#Menu .Fortalecimiento p {
  width: 161px;
  height: 24px;
  margin: 14px 20px 0 5px;/*top-right-bottom-left*/
  font-family: Montserrat;
  font-size: 18px;
  font-weight: bold;
  font-stretch: normal;
...
#Menu .Acompanamiento img {
  width: 92px;
  height:80px;
  margin: 30px 25px 10px 50px;/*top-right-bottom-left*/
}
#Menu .Acompanamiento .Lnea-7 {
  width: 0;
  height: 159px;
  margin: 0px 0 43.5px;/*top-right-bottom-left*/
  border: solid 1px #e6effd;
}
#Menu .Acompanamiento p {
  width: 161px;
  height: 24px;
  margin: 14px 20px 0 5px;/*top-right-bottom-left*/
  font-family: Montserrat;
...
#Menu .Capacitacion img {
  width: 92px;
  height:90px;
  margin: 20px 15px 10px 25px;/*top-right-bottom-left*/
}
#Menu .Capacitacion .Lnea-4 {
  width: 0;
  height: 159px;
  margin: 0px 0 43.5px;/*top-right-bottom-left*/
  border: solid 1px #e6effd;
